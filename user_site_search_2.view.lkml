view: user_site_search_2 {
  sql_table_name: public.user_site_search_2 ;;
  ...
  dimension: mn_local_search_results {
    type: string
    sql: ${TABLE}.mn_local_search_results ;;
  }
  ...
  dimension: mn_search_text {
    type: string
    sql: ${TABLE}.mn_search_text ;;
  }
